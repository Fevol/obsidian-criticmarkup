...
export function text_insert(cursor_range: EditorEditChange, ranges: CriticMarkupRanges, offset: number, state: EditorState,
                            insert_type: MarkType, metadata_fields?: MetadataFields,
): OperationReturn {
