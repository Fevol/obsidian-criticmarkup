import {CriticMarkupRange, METADATA_TYPE, MetadataFields} from "../ranges";
...
export function range_metadata_compatible(range: CriticMarkupRange, metadata_fields?: MetadataFields, metadata_compatibility: MetadataCompatibility = METADATA_INCOMPATIBILITY) {
